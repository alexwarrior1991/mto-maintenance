...
public class KeycloakJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
     ...
     * {@code mto-maintenance-technician} ya llega con {@code maintenance-read} y {@code maintenance-write} dentro de
     * {@code resource_access}. Comprobar un perfil sigue siendo posible, pero hay que nombrarlo:
     * {@code hasRole("REALM_MTO_MAINTENANCE_TECHNICIAN")}.</p>
     */
     ...
     * comprobarlos aquí como es costumbre en Spring: {@code maintenance-read} se convierte en
     * {@code MAINTENANCE_READ}, listo para {@code hasRole("MAINTENANCE_READ")}.
     *
     * <p>La conversión no es inyectiva: {@code maintenance-read}, {@code stock_read} y {@code Stock Read}
