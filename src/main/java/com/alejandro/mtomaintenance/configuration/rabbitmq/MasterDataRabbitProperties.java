...
public record MasterDataRabbitProperties(
    ...
    public MasterDataRabbitProperties {
        ...
        queue = defaultIfBlank(queue, MasterDataRabbitMqNames.MAINTENANCE_MASTER_DATA_QUEUE);
        ...
        deadLetterExchange = defaultIfBlank(
                deadLetterExchange, MasterDataRabbitMqNames.MAINTENANCE_MASTER_DATA_DEAD_LETTER_EXCHANGE);
        deadLetterQueue = defaultIfBlank(
                deadLetterQueue, MasterDataRabbitMqNames.MAINTENANCE_MASTER_DATA_DEAD_LETTER_QUEUE);
        deadLetterRoutingKey = defaultIfBlank(
                deadLetterRoutingKey, MasterDataRabbitMqNames.MAINTENANCE_MASTER_DATA_DEAD_LETTER_ROUTING_KEY);
    }
